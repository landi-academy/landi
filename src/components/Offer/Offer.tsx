      ...
      <div className="container">
        <div className={styles.offerWrapper}>
          <div className={styles.offerContent}>
            <p className={`${styles.offerPreTitle} ${caveat.className}`}>
              {offer.preTitle}
            </p>
            <h1 className={`${styles.offerTitle} ${bigShoulders.className}`}>
              {offer.title}
            </h1>
          ...
          <div className={styles.offerImage}>
            ...
            <div className={styles.lineBlock}>
              ...
              >
                <path
                  d="M291 580C130.837 580 1 450.386 1 290.5C1 130.614 130.837 1 291 1"
                  stroke="url(#paint0_linear_67_63)"
                  strokeOpacity="0.6"
                  strokeWidth="1.5"
                ></path>{" "}
                <defs>
              ...
              {offer.bulletsList.map((bullet, index) => (
                ...
                >
                  <div className={styles.highlightText}>{bullet.text}</div>
                </div>
              ))}
            </div>
          </div>
